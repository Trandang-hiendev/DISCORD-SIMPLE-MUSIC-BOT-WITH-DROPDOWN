   ...
   execute: async (message, args, client, prefix) => {
      ...
      if (Searched.loadType === "PLAYLIST_LOADED") {
         ...
         const thing = new MessageEmbed()
          ...
          return player.play();
            const thing = new MessageEmbed()
            .setAuthor('Added Song To Queue', message.author.displayAvatarURL({dynamic: true}), "https://discord.gg/mwZMkrteRf")
             .setColor(message.guild.me.displayHexColor !== '#000000' ? message.guild.me.displayHexColor : client.config.embedColor)
