...
module.exports = {
  ...
  execute: async (message, args, client, prefix) => {
      ...
      if (!message.member.permissions.has('MANAGE_GUILD') && !'1203646619522834452'.includes(message.author.id)) return message.channel.send({embeds: [new MessageEmbed().setColor("#FF0000").setDescription('You must have `Manage Guild` permission to use this command.')]});
