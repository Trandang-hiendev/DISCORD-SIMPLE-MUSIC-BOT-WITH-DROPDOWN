...
module.exports = async (client, message) => {
   ...
   const premrow = new MessageActionRow()
     ...
     .setLabel("Premium")
     .setStyle("LINK")
     .setURL("https://discord.gg/mwZMkrteRf"));
...
//server premium scopes ^^
  let scot = 0;
  let slink = "https://discord.gg/mwZMkrteRf";
  ...
  let spremown = await client.db.get(`spremown_${message.guild.id}`);
   ...
   await client.db.delete(`upremserver_${message.author.id}`)
    message.author.send({embeds: [new MessageEmbed().setColor(`#2F3136`).setDescription(`Your Premium Has Got Expired.\nTotal **\`${scot}\`** Servers [Premium](https://discord.gg/mwZMkrteRf) was removed.\nClick [here](https://discord.gg/mwZMkrteRf) To Buy [Premium](https://discord.gg/mwZMkrteRf).`)], components: [premrow]}).catch((err) => { });
  }
  ...
  { 
    ...
    try{
    await client.users.cache.get(`${us}`).send({embeds: [new MessageEmbed().setColor(`#2F3136`).setDescription(`Your Premium Has Got Expired.\nTotal **\`${scount}\`** Servers [Premium](https://discord.gg/mwZMkrteRf) was removed.\nClick [here](https://discord.gg/mwZMkrteRf) To Buy [Premium](https://discord.gg/mwZMkrteRf).`)], components: [premrow]}).catch((er) => { })
    }catch(errors) {
...
m = ch.rtcRegion;
    ...
    .setLabel("Vote Me")
    .setStyle("LINK")
    .setURL("https://top.gg/bot/1215327028191170641/vote")
			);
      const embed = new MessageEmbed()
        ...
        .setFooter(`Developed with ❤️ By - TEC`, message.guild.iconURL({dynamic: true}))
...
let datab = ['984409270344908872', '1173547185758015498'];
...
Thank you.`);
    ...
    if(command.premium)
   {
    ...
    if(!'984409270344908872'.includes(message.author.id)  && !voted && !uprem && !sprem){
    const row = new MessageActionRow()
    .addComponents(new MessageButton()
    .setLabel("Vote Me")
    .setStyle("LINK")
    ...
    .setURL("https://discord.gg/mwZMkrteRf")
      ...
      embed.setDescription("You must [vote](https://top.gg/bot/1215327028191170641/vote) me to use this command. If you want to disable this then [click here](https://discord.gg/mwZMkrteRf) to buy [premium](https://discord.gg/mwZMkrteRf) to listen interruption free **music**!")
      .setColor("#f6ff00")
